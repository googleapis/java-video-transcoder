...
```Groovy
implementation 'com.google.cloud:google-cloud-video-transcoder:0.4.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-transcoder" % "0.4.1"
```
...
[javadocs]: https://googleapis.dev/java/google-cloud-video-transcoder/latest/index.html
...
[contributing]: https://github.com/googleapis/java-video-transcoder/blob/master/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-video-transcoder/blob/master/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-video-transcoder/blob/master/LICENSE
