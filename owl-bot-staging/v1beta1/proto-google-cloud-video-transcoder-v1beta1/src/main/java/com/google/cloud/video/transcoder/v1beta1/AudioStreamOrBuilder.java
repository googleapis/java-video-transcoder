...
public interface AudioStreamOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.video.transcoder.v1beta1.AudioStream)
   ...
   */
  java.util.List<com.google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtom> 
      getMappingList();
  /**
   * <pre>
   * The mapping for the `Job.edit_list` atoms with audio `EditAtom.inputs`.
   ...
   * <code>repeated .google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtom mapping = 5;</code>
   */
  com.google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtom getMapping(int index);
  /**
   * <pre>
   * The mapping for the `Job.edit_list` atoms with audio `EditAtom.inputs`.
   * </pre>
   ...
   * <code>repeated .google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtom mapping = 5;</code>
   */
  java.util.List<? extends com.google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtomOrBuilder> 
   ...
   * <code>repeated .google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtom mapping = 5;</code>
   */
  com.google.cloud.video.transcoder.v1beta1.AudioStream.AudioAtomOrBuilder getMappingOrBuilder(
      int index);
