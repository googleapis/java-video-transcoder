...
public interface MuxStreamOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.video.transcoder.v1beta1.MuxStream)
   ...
   */
  com.google.cloud.video.transcoder.v1beta1.SegmentSettings getSegmentSettings();
  /**
   * <pre>
   * Segment settings for `"ts"`, `"fmp4"` and `"vtt"`.
   * </pre>
   ...
   * <code>.google.cloud.video.transcoder.v1beta1.SegmentSettings segment_settings = 5;</code>
   */
  com.google.cloud.video.transcoder.v1beta1.SegmentSettingsOrBuilder getSegmentSettingsOrBuilder();
   ...
   */
  com.google.cloud.video.transcoder.v1beta1.Encryption getEncryption();
  /**
   * <pre>
   * Encryption settings.
   * </pre>
   ...
   * <code>.google.cloud.video.transcoder.v1beta1.Encryption encryption = 6;</code>
   */
  com.google.cloud.video.transcoder.v1beta1.EncryptionOrBuilder getEncryptionOrBuilder();
}
